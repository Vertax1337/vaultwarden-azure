...
resource appName_ensure_kv_secrets 'Microsoft.Resources/deploymentScripts@2023-08-01' = {
  ...
  properties: {
    ...
    environmentVariables: [
      ...
      {
        name: 'SMTP_USE_AUTH'
        value: toLower(string(smtpUseAuth))
      }
      {
      ...
      {
        name: 'SSO_ENABLED'
        value: toLower(string(ssoEnabled))
      }
      {
      ...
      {
        name: 'PUSH_ENABLED'
        value: toLower(string(pushEnabled))
      }
      {
      ...
      }
      {
        ...
        value: toLower(string(acsDeployFoundation))
      }
      {
